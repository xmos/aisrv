...
static imx219_settings_t chip_set_up[] = {
	...
	{ 0x8306, 0x0022 }, /* PLL_VT_MPY        0x27, for multiply by 39, pixclk=187.2 MHz */
	{ 0x830C, 0x0038 }, /* PLL_OP_MPY        0x40, for multiply by 64, MIPI clk=768 MHz */
	...
	{ 0x0174,   0x01 }, /* BINNING_MODE_H_A     2, for 4x binning */
	{ 0x0175,   0x01 }, /* BINNING_MODE_V_A     2, for 4x binning */
    ...
    { 0x8166, SWIDTH }, /* X_ADD_END       SWIDTH, Full width */
    { 0x8168,      0 }, /* Y_ADD_STA            0, No crop on top */
    { 0x8166, SHEIGHT}, /* Y_ADD_END      SHEIGHT, Full height */
    { 0x816C, SWIDTH }, /* x_output_size   SWIDTH, Full width */
    { 0x816E, SHEIGHT}, /* y_output_size  SHEIGHT, Full height */
    
	{ 0x30EB,   0x05 }, /* Higher address space enable: */
	{ 0x30EB,   0x0C },
	{ 0x300A,   0xFF },
	{ 0x300B,   0xFF },
	{ 0x30EB,   0x05 },
	{ 0x30EB,   0x09 },
	{ 0x455E,   0x00 }, /* The following values float around on the internet. No idea */
	{ 0x471E,   0x4B }, /* Tuning the imaging sensor */ 
	{ 0x4767,   0x0F }, 
	{ 0x4750,   0x14 }, 
	{ 0x4540,   0x00 }, 
	{ 0x47B4,   0x14 }, 
