...
#define TENSOR_ARENA_BYTES_0          (384000)
...
uint32_t *data_ext_model = (uint32_t *)0x10000000;//[TENSOR_ARENA_BYTES_0/sizeof(int)];  // engine 0, tile 1
uint32_t data_ext[TENSOR_ARENA_BYTES_0/sizeof(int)];  // engine 0, tile 1
...
void inference_engine_initialize_with_memory_0(inference_engine_t *ie) {
    ...
    auto *resolver = inference_engine_initialize(ie,
                                                 ...
                                                 data_ext_model + (TENSOR_ARENA_BYTES_0/8) ,  0,
                                                 &s0);
    resolver->AddPad();
    resolver->AddReshape();
